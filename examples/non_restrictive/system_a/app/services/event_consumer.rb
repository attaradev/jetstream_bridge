...
# Event Consumer Service for System A
# Subscribes to events from System B and syncs data idempotently

class EventConsumer
  def self.start!
    Rails.logger.info 'Starting EventConsumer for System A...'

    # Subscribe to events from System B and start consuming
